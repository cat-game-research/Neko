...
{
	/// <summary>This component allows you to generate the <b>LightingTex</b> setting for jovian materials.</summary>
	[ExecuteInEditMode]
	[RequireComponent(typeof(SgtJovian))]
	[HelpURL(SgtCommon.HelpUrlPrefix + "SgtJovianLightingTex")]
	[AddComponentMenu(SgtCommon.ComponentMenuPrefix + "Jovian LightingTex")]
	public class SgtJovianLightingTex : MonoBehaviour
	{
		...
		{
			var importer = CwHelper.ExportTextureDialog(generatedTexture, "Jovian LightingTex");
...
namespace SpaceGraphicsToolkit.Jovian
{
	...
	public class SgtJovianLightingTex_Editor : CwEditor
	{
